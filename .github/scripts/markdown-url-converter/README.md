...
1. Inline links: `[text](https://github.com/hashicorp/terraform-google-boundary-enterprise-controller-hvd/blob/0.2.0/.github/scripts/markdown-url-converter/url)`
2. Image links: `![alt](https://github.com/hashicorp/terraform-google-boundary-enterprise-controller-hvd/blob/0.2.0/.github/scripts/markdown-url-converter/url)`
